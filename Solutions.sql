-- Data Exploration of Monday Coffee
...
-- How many people in each city are estimated to consume coffee, given that 25% pf the population does ?
...
-- CITY 1 : PUNE
	...
	3. avg_sale per cx also very high.
